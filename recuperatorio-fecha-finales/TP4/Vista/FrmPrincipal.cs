        ...
        private void dgLibreria_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (this.dgLibreria.RowCount != 0)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(null, "Para hacer zoom seleccione un solo libro por favor");
                    }
                }
                else
                {
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.dgLibreria.RowCount != 0) 
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(null,"Para borrar de la libreria seleccione un solo libro por favor.");
                    }
                }
                else
                {
        ...
        private void btnAgregarPedido_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.dgLibreria.RowCount != 0)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(null,"No hay ningun libro seleccionado.");
                    }
                }
                else
                {
